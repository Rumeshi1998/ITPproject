...
<div id="myBtnContainer">
	<button class="btn active" onclick="filterSelection('all')"> Basic pakage</button>
  	<button class="btn" onclick="filterSelection('nature')"> Premium package</button>
  	<button class="btn" onclick="filterSelection('cars')"> Premium plus package</button>
</div>
