...
<div id="myBtnContainer">
	<button class="btn" onclick="location.href='MainPartnerPage.jsp';"> Basic package</button>
  	<button class="btn " onclick="location.href='MainPremiumPackagePage.jsp';"> Premium package</button>
  	<button class="btn active" onclick="location.href='MainPremiunmPlusPakacgePage.jsp';"> Premium plus package</button>
</div>
