...
<div id="myBtnContainer">
	<button class="btn" onclick="location.href='SecondPartnerPage.jsp';"> Basic package</button>
  	<button class="btn" onclick="location.href='SecondPremiumPackagePage.jsp';"> Premium package</button>
  	<button class="btn active" onclick="location.href='SecondPremiunmPlusPakacgePage.jsp';"> Premium plus package</button>
</div>
